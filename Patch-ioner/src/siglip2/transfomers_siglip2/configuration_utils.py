...
def is_timm_config_dict(config_dict) -> bool:
...
class PreTrainedConfig(PushToHubMixin):
    ...
    attribute_map: dict = {}
    base_model_tp_plan: Optional[dict] = None
    base_model_pp_plan: Optional[dict] = None
    base_model_ep_plan: Optional[dict] = None
    ...
    def dict_dtype_to_str(self, d: dict) -> None:
        """
    ...
    def _remove_keys_not_serialized(self, d: dict) -> None:
        """
    ...
    @staticmethod
    def _get_global_generation_defaults() -> dict:
        return {
            "max_length": 20,
            "min_length": 0,
            "do_sample": False,
...
def get_configuration_file(configuration_files: list) -> str:
    """
...
def layer_type_validation(layer_types: list, num_hidden_layers: Optional[int] = None):
