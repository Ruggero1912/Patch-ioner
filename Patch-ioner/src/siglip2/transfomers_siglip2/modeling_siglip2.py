...
from src.siglip2.transfomers_siglip2 import configuration_siglip2

try:
    from .modeling_layers import GradientCheckpointingLayer
except ImportError:
    from src.siglip2.transfomers_siglip2.modeling_layers import GradientCheckpointingLayer

from transformers.modeling_outputs import BaseModelOutput, BaseModelOutputWithPooling, ImageClassifierOutput
from transformers.modeling_utils import PreTrainedModel
#ALL_ATTENTION_FUNCTIONS
from transformers.processing_utils import Unpack
from transformers.utils import ModelOutput, filter_out_non_signature_kwargs
...
try:
    ...
    from src.siglip2.transfomers_siglip2.configuration_siglip2 import Siglip2Config, Siglip2TextConfig, Siglip2VisionConfig
...
class Siglip2Model(Siglip2PreTrainedModel):
    ...
    def __init__(self, config: Siglip2Config):
        ...
        # TypeError: config.text_config is expected to be of type Siglip2TextConfig but is of type <class 'configuration_siglip2.Siglip2TextConfig'>.
        # to fix that, we need to explicitly check the types here

        # if not isinstance(config.text_config, Siglip2TextConfig) \
        #     and not isinstance(config.text_config, configuration_siglip2.Siglip2TextConfig):
        #     raise TypeError(
