...
def train(
    ...
    for epoch in range(epochs):
        ...
        progress = tqdm(total = len(dataloader), desc = output_prefix, dynamic_ncols=True)
        train_loss_sum = 0
        # training
...
def main():
    ...
    parser.add_argument('--path_of_datasets', default = '/raid/datasets/viecap_files/annotations/coco/coco_with_entities.pickle')
    parser.add_argument('--out_dir', default = '/raid/datasets/viecap_files/checkpoints', help = 'the path of output')
    ...
    parser.add_argument('--path_of_objects_vocabs', default = '/raid/datasets/viecap_files/annotations/vocabulary/all_objects_attributes_relationships.pickle')
    ...
    parser.add_argument('--clip_hidden_size', type = int, default = 512, help = 'hidden size of CLIP text encoder, 512 for ViT, 640 for RN')
    ...
    if args.is_rn:
        assert clip_hidden_size == 640, 'clip_hidden_size should be 640 for RN50. Received {}.'.format(clip_hidden_size)
