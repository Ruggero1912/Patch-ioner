...
def get_args():
    ...
    parser.add_argument("--memory_id", type=str, default=r"coco_B16",help="memory name")
    ...
    parser.add_argument("--memory_path", type=str, default="/raid/datasets/meacap_files/memory/coco/memory_captions.json")
    ...
    parser.add_argument('--vl_model', type=str, default=r'openai/clip-vit-base-patch16')
    ...
    parser.add_argument("--memory_base_path", type=str, default="/raid/datasets/meacap_files/")
