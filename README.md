...
Official repository containing the code for the paper **"One Patch to Caption Them All: A Unified Zero-Shot Captioning Model"**.
...
### Patch-ioner DINOv2 ImProj Karpathy Train Split
...
### Patch-ioner DINOv2 Noise Karpathy Train Split
